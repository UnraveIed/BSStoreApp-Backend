...
namespace Services
{
    public class BookManager : IBookService
    {
        ...
        public async Task<(IEnumerable<ExpandoObject> bookDto, MetaData metaData)> GetAllBooksAsync(BookParameters bookParameters, bool trackChanges)
        {
            ...
            return (bookDto: shapedData, metaData: booksWithMetaData.MetaData);
        }
